...
extension DateTimeX on DateTime {
  String formatDate([String? locale]) =>
      DateFormat('yyyy/MM/dd', locale).format(toLocal());

  String formatTime([String? locale]) =>
      DateFormat('hh:mm a', locale).format(toLocal());

  String formatDOW([String? locale]) =>
      DateFormat('EEEE', locale).format(toLocal());

  String format([String? locale]) =>
      DateFormat('yyyy/MM/dd hh:mm', locale).format(toLocal());
